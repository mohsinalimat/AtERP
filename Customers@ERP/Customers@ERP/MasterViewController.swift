...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func configureCell(_ cell: CustomerCell, withEvent event: Event, indexPath: IndexPath) {
        let customer = controller.object(at: indexPath)
    ...
    func attemptFetch() {
        ...
        let a_zSortDescriptor = NSSortDescriptor(key: "customerLastName", ascending: true, selector: #selector(NSString.caseInsensitiveCompare))
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        ...
        case .update:
            configureCell(tableView.cellForRow(at: indexPath!)! as! CustomerCell, withEvent: anObject as! Event, indexPath: indexPath!)
        case .move:
            configureCell(tableView.cellForRow(at: indexPath!)! as! CustomerCell, withEvent: anObject as! Event, indexPath: indexPath!)
